    ...
    <div className="font-sans">
      ...
      <div className="max-w-[1183px] mx-32 mt-14 mb-20">
        ...
        <p className="leading-[1.75] mb-10">
          For questions, feedback, or to contribute photos and species information to this site,
          please reach out to the Boulder County Nature Association through the contact form on the{" "}
          <a
          ...
          . We welcome participation from photographers, naturalists, and enthusiasts of all experience levels.
          All submitted and approved images will be credited with copyright retained by the original photographer.
        </p>
